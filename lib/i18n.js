...
i18n.use(initReactI18next).init({
  resources: {
    en: { common: commonEN, home: homeEN, employers: employersEN, jobSeekers: jobSeekersEN, about: aboutEN, industries: industriesEN, locations: locationsEN },
    es: { common: commonES, home: homeES, employers: employersES, jobSeekers: jobSeekersES, about: aboutES, industries: industriesES, locations: locationsES },
    vi: { common: commonVI, home: homeVI, employers: employersVI, jobSeekers: jobSeekersVI, about: aboutVI, industries: industriesVI, locations: locationsVI },
  },
  lng: savedLang || 'en',
  fallbackLng: 'en',
  defaultNS: 'common',
